...
class KotItem {
  ...
  @override
  String toString() {
    return 'KotItem ( SlNo: "$slNo", ItemId: "$itemId",CatId: "$catid", Name: "$name", SRate: "$sRate",Printer :"$printer","Quantity: "$quantity",OldQty: "$oldqty",ItemStatus "$ItemStatus",NetAmount:$NetAmount, AddonItems: $addonItems, )';
  }
}
