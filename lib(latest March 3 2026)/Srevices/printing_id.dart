...
//         child: Container(
//           height: MediaQuery.of(context).size.height * 0.47, // 40% screen height
...
//                         Expanded(flex: 2, child: Center(child: Text("Rate", style: TextStyle(fontWeight: FontWeight.bold)))),
//                         Expanded(flex: 2, child: Center(child: Text("Total", style: TextStyle(fontWeight: FontWeight.bold)))),
//                         Expanded(flex: 2, child: Center(child: Text("Remove", style: TextStyle(fontWeight: FontWeight.bold)))),
//                       ],
//                     ),
//                   ),
//
...
//                                                   if (item.quantity < newQuantity) {item.itemModifiedStatus = 'ADD_QTY';
//                                                   } else if (item.quantity > newQuantity) {item.itemModifiedStatus = 'CANCELLED_QTY';
//                                                   }
//                                                 }
//                                                 item.quantity = newQuantity;
//                                                 item.NetAmount = item.sRate * newQuantity;
//                                               }
//                                             } else {
//                                               item.quantity = newQuantity;
//                                               item.NetAmount = item.sRate * newQuantity;
...
//                                       final itemName = item.name; // current row item
...
//                         onPressed: () async {
//                           if (kotProviders.kotDatasrunning
//                               .isEmpty) return;
//
//                           final receivedKOT =
//                               kotProviders.kotDatasrunning.first;
//
//                           await reprintFullKOT(
//                               kotProviders, receivedKOT);
//                         },
//                       ),
//
//                       const SizedBox(width: 10),
...
//                         onPressed: () async {
//                           final noteText =
//                           kotProviders.noteController.text
//                               .trim();
//
...
//                             selectedSeats,
//                             kotProviders
//                                 .selectedItemsOldPrintList,
//                             noteText,
//                           );
//
//                           kotProviders.clearAll();
//                         },
